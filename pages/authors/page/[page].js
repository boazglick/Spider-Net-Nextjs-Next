...
import authorsPageInitialPropsTqI5Resource from '../../../resources/authors-page-initial-props-tq_i5'
import authorsPageInitialPathsTqSbResource from '../../../resources/authors-page-initial-paths-tq_sb'
...
export async function getStaticProps(context) {
  try {
    const response = await authorsPageInitialPropsTqI5Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await authorsPageInitialPathsTqSbResource({})
