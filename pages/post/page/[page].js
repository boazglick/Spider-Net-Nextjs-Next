...
import postPageInitialPropsTqQnResource from '../../../resources/post-page-initial-props-tq_qn'
import postPageInitialPathsTqYUResource from '../../../resources/post-page-initial-paths-tq_y-u'
...
export async function getStaticProps(context) {
  try {
    const response = await postPageInitialPropsTqQnResource({
      ...context?.params,
    })
    if (!response) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await postPageInitialPathsTqYUResource({})
