      ...
      <div className="post-container">
            ...
            <>
              ...
              <div className="post-image-style">
                <DataProvider
                  ...
                  renderSuccess={(context_0279tj) => (
                    <>
                      <div className="post-overlay-image">
                        <div className="post-container3"></div>
                        <img
                          alt="image"
                          src={
                            context_0279tj?.source_url ||
                  ...
                  renderLoading={() => (
                    <>
                      ...
                      <span className="post-loading1">Loading image ...</span>
                    </>
                  )}
                  renderError={() => (
                    <>
                      <span className="post-error1">
                        There was an error reading this item
                      </span>
                    </>
                  )}
                  params={{
              ...
              <div className="post-content-style">
                ...
                <div className="post-date-style">
                  <span className="post-text4">פורסם בתאריך:</span>
                  <span className="post-date-time">
                    <DateTimePrimitive
                      format="DD/MM/YYYY"
                      date={PostEntity?.date || '08/01/1976'}
                    ></DateTimePrimitive>
                  </span>
                </div>
        ...
        <footer className="post-footer">
          ...
          <div className="post-container5">
            <span className="post-text5">2024</span>
            <span className="post-text6">
