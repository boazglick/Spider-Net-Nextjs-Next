...
import postPageInitialPropsTqI9Resource from '../../resources/post-page-initial-props-tq_i9'
import postPageInitialPathsTq0eResource from '../../resources/post-page-initial-paths-tq_0e'
            ...
            <>
              ...
              <div className="post11-featured-image">
                <DataProvider
                  ...
                  renderSuccess={(context_krhml4) => (
                    <>
                      <div className="post11-container3">
                        <div className="post11-container4">
                          <div id="cont13b5" className="post11-date-and-author">
                            <span className="post11-prefix">
                              פורסם בתאריך: 
                            </span>
                            <span className="post11-date-time">
                              <DateTimePrimitive
                                format="DD/MM/YYYY"
                                date="2024-03-02T15:34:59.248Z"
                              ></DateTimePrimitive>
                            </span>
                          </div>
                        </div>
...
export async function getStaticProps(context) {
  try {
    const response = await postPageInitialPropsTqI9Resource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await postPageInitialPathsTq0eResource({})
    return {
