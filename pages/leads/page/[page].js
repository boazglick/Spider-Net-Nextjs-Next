...
import leadsPageInitialPropsTqUnResource from '../../../resources/leads-page-initial-props-tq_un'
import leadsPageInitialPathsTqR8Resource from '../../../resources/leads-page-initial-paths-tq_r8'
...
export async function getStaticProps(context) {
  try {
    const response = await leadsPageInitialPropsTqUnResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await leadsPageInitialPathsTqR8Resource({})
