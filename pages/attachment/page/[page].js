...
import attachmentPageInitialPropsTqNsResource from '../../../resources/attachment-page-initial-props-tq_ns'
import attachmentPageInitialPathsTqY0Resource from '../../../resources/attachment-page-initial-paths-tq_y0'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTqNsResource({
      ...context?.params,
    })
    if (!response) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await attachmentPageInitialPathsTqY0Resource({})
