...
import attachmentPageInitialPathsTqJ0Resource from '../../resources/attachment-page-initial-paths-tq_j0'
...
export async function getStaticPaths() {
  try {
    const response = await attachmentPageInitialPathsTqJ0Resource({})
    return {
