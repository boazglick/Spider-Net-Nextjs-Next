...
import attachmentPageInitialPropsTq6rResource from '../../resources/attachment-page-initial-props-tq_6r'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTq6rResource({
      ...context?.params,
    })
    if (!response) {
      return {
