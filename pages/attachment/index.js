...
import attachmentPageInitialPropsTqYlResource from '../../resources/attachment-page-initial-props-tq_yl'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTqYlResource({
      ...context?.params,
    })
    if (!response) {
      return {
