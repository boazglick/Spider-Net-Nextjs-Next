...
import attachmentPageInitialPropsTqPxResource from '../../resources/attachment-page-initial-props-tq_px'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTqPxResource({
      ...context?.params,
    })
    if (!response) {
      return {
