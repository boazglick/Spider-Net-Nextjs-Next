...
import attachmentPageInitialPropsTq04Resource from '../../resources/attachment-page-initial-props-tq_04'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTq04Resource({
      ...context?.params,
    })
    if (!response) {
      return {
