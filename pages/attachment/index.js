...
import attachmentPageInitialPropsTqPResource from '../../resources/attachment-page-initial-props-tq_p_'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTqPResource({
      ...context?.params,
    })
    if (!response) {
      return {
