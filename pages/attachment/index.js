...
import attachmentPageInitialPropsTqUqResource from '../../resources/attachment-page-initial-props-tq_uq'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTqUqResource({
      ...context?.params,
    })
    if (!response) {
      return {
