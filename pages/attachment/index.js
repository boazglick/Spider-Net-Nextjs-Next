...
import attachmentPageInitialPropsTqEqResource from '../../resources/attachment-page-initial-props-tq_eq'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialPropsTqEqResource({
      ...context?.params,
    })
    if (!response) {
      return {
