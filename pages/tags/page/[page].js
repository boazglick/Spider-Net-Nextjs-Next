...
import tagsPageInitialPropsTq1Resource from '../../../resources/tags-page-initial-props-tq_1-'
import tagsPageInitialPathsTqVlResource from '../../../resources/tags-page-initial-paths-tq_vl'
...
export async function getStaticProps(context) {
  try {
    const response = await tagsPageInitialPropsTq1Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await tagsPageInitialPathsTqVlResource({})
