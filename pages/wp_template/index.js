...
import wpTemplatePageInitialPropsTqDtResource from '../../resources/wp_template-page-initial-props-tq_dt'
...
export async function getStaticProps(context) {
  try {
    const response = await wpTemplatePageInitialPropsTqDtResource({
      ...context?.params,
    })
    if (!response) {
      return {
