    ...
    <>
      <div className="home-page-container">
              ...
              <Link href="/contact">
                <a className="home-page-link2">
                  <div className="home-page-container2">
                    ...
                    <span className="home-page-text01">צור קשר</span>
                  </div>
                </a>
              </Link>
            </nav>
        ...
        <div className="home-page-top-title">
          <span className="home-page-text02">כל המאמרים</span>
        </div>
        <div className="home-page-container3">
          <DataProvider
                  ...
                  renderItem={(PostlistHome) => (
                    <>
                      <Link href={`/post/${PostlistHome?.id}`}>
                        <a>
                          <div className="home-page-product-minitura">
                            ...
                            <div className="home-page-date-and-author">
                              ...
                              <span className="home-page-date-time">
                                <DateTimePrimitive
                                  format="DD/MM/YYYY"
                                  date={PostlistHome?.date || '08/01/1976'}
                                ></DateTimePrimitive>
                              </span>
                            </div>
            ...
            renderError={() => (
              <>
                <span className="home-page-text05">
                  There Was An Error Loading Data
                </span>
        ...
        <footer className="home-page-footer">
          ...
          <div className="home-page-container5">
            <span id="Year" className="home-page-text09">
              2024
            </span>
            ...
            <a
              ...
              className="home-page-link8"
            >
              Code design by 011.ninja
            </a>
          </div>
          <div className="home-page-icon-group1">
            <svg
              viewBox="0 0 950.8571428571428 1024"
...
export async function getStaticProps(context) {
  try {
    const postlistHomeProp = await homePageResource({
      ...context?.params,
    })
    if (!postlistHomeProp) {
      return {
