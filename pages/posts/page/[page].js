...
import postsPageInitialPropsTqA0Resource from '../../../resources/posts-page-initial-props-tq_a0'
import postsPageInitialPathsTqTiResource from '../../../resources/posts-page-initial-paths-tq_ti'
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsTqA0Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await postsPageInitialPathsTqTiResource({})
